...
// Geheim voor tijdelijke reset-tokens na een gedeelde check-in.
// Gebruik in productie bij voorkeur een eigen sterke waarde.
export const CHECKIN_RESET_SECRET =
  process.env.CHECKIN_RESET_SECRET ??
  process.env.ADMIN_PASSWORD ??
  'local-checkin-reset-secret';
